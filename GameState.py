...
class GameManager:
    ...
    def get_champion_img(championRawID, skinRawID):
        ...
        if res.status_code != 200:
            logging.error(f"Error code {res.status_code} when getting art for {championRawID}/{skinRawID}.")
